...
public final class ActivityLoginTestBinding implements ViewBinding {
  ...
  private ActivityLoginTestBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
      @NonNull Button signInButton, @NonNull TextView statusText) {
  ...
  public static ActivityLoginTestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginTestBinding((LinearLayout) rootView, progressBar, signInButton,
          statusText);
    }
