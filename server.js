...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('🔐 Authentication: Firebase ID tokens required for data endpoints');
  console.log('📋 Available endpoints:');
  console.log('   GET /api/health (public)');
  console.log('   GET /api/topics (protected)');
  console.log('   GET /api/questions/:topicId/:difficulty (protected)');
